...
const Welcome = () => {
  ...
  return (
    <div className="w-full flex justify-center items-center">
      <div className="flex mf:flex-row flex-col item-start justify-between mf:p-20 px-4 py-12">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p className="text-white mt-5 text-left font-light md:w-9/12 w-11/12 text-base">
            Explore the cypto world. Buy and Sell crypto currencies easily.
          </p>
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 w-full mt-10">
            ...
            <div className={`rounder-br-2xl ${commonStyles}`}>Blockchain</div>
          </div>
        </div>
